...
- Usa documentKind de forma coherente con el caso: medida-proteccion solo cuando el relato describa violencia o riesgo en contexto familiar; solicitud-alimentos cuando el asunto principal sea cuota alimentaria o pensión alimenticia sin violencia; resumen-familia para custodia, visitas u otros asuntos familiares sin violencia.
...
${JSON.stringify(sourceCatalog)}`,
    ...
    if (parsed.category === "familia") {
      documentKind =
        ...
        (fallback.documentKind === "medida-proteccion" ||
          fallback.documentKind === "solicitud-alimentos" ||
          fallback.documentKind === "resumen-familia")
